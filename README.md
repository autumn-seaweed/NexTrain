...
* **秒単位のカウントダウン**: 駅のホームにある電光掲示板と同じように、「あと3分45秒」といった正確な発車までの時間を表示します。
* **ホーム画面ウィジェット**: アプリを開く必要はありません。iPhoneのホーム画面やロック画面を見るだけで、走るべきか歩くべきかが分かります。
* **プライバシーファースト**: 位置情報や利用データはすべてデバイス内で処理されます。外部サーバーへの送信は一切行いません。
* **主要路線に対応**: JR東日本、東京メトロ、都営地下鉄（三田線など）を含む首都圏の主要路線をサポート。
